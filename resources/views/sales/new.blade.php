                ...
                <div class="card-body">
                    <form class="forms-sample" method="post" action="{{ url('/purchases/new') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control " id="date" name="sales_date" placeholder="Enter date">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="num" step="1" min="1" class="form-control" id="item" name="product_id" placeholder="Item">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label for="price" class="col-sm-3 col-form-label">Tax Invoice*</label>
                            <div class="col-sm-9">
                                <input type="num" step="1" min="1" class="form-control" id="item" name="tax_invoice_id" placeholder="Item">
                            </div>
                        </div>
