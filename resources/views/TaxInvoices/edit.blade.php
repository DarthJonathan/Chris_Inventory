                ...
                <div class="card-body">
                    <form class="forms-sample" method="post" action="{{ url('/customers/new') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" id="invoiceno" name="invoiceno" placeholder="Enter Invoice No" value="{{ $invoice_no }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="date" id="date" class="form-control" placeholder="Enter Date" value="{{ $date }}">
                            </div>
                        </div>
